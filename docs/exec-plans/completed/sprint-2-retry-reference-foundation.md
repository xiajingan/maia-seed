...
| S2-X01 | library-close | planned | - | 在全部 Library 交付门禁通过后归档本 Sprint | S2-L01 | `docs/exec-plans/completed/sprint-2-retry-reference-foundation.md` | 全部前置 Library 任务完成；计划原子归档到 completed | done |
